...
public:
    ...
    Variant(int v)
        : type_(kTypeInt)
        , value_() // NOLINT(google-explicit-constructor,hicpp-explicit-conversions)
    {
        *this = v;
    }
...
template <>
struct Variant::Getter<Variant::String> {
...
template <>
struct Variant::Getter<Quaternion> {
...
template <>
struct Variant::Getter<Vector2i> {
...
template <>
struct Variant::Getter<Vector3i> {
...
template <>
struct Variant::Getter<Vector4i> {
...
template <>
struct Variant::Getter<Matrix2i> {
...
template <>
struct Variant::Getter<Matrix3i> {
...
template <>
struct Variant::Getter<Matrix4i> {
...
template <>
struct Variant::Getter<SharedPtr<RefCounted>> {
...
template <>
struct Variant::Getter<Variant::Vector> {
...
template <>
struct Variant::Getter<Variant::Map> {
...
template <class T>
inline Variant::Type GetVariantType();
template <>
inline Variant::Type GetVariantType<int>()
{
    return Variant::kTypeInt;
}
template <>
inline Variant::Type GetVariantType<int64_t>()
{
    return Variant::kTypeInt64;
}
template <>
inline Variant::Type GetVariantType<float>()
{
    return Variant::kTypeFloat;
}
template <>
inline Variant::Type GetVariantType<double>()
{
    return Variant::kTypeDouble;
}
template <>
inline Variant::Type GetVariantType<bool>()
{
    return Variant::kTypeBool;
}
template <>
inline Variant::Type GetVariantType<Variant::String>()
{
...
template <>
inline Variant::Type GetVariantType<Color>()
{
    return Variant::kTypeColor;
}
template <>
inline Variant::Type GetVariantType<Quaternion>()
{
    return Variant::kTypeQuaternion;
}
template <>
inline Variant::Type GetVariantType<Vector2>()
{
    return Variant::kTypeVector2f;
}
template <>
inline Variant::Type GetVariantType<Vector3>()
{
    return Variant::kTypeVector3f;
}
template <>
inline Variant::Type GetVariantType<Vector4>()
{
    return Variant::kTypeVector4f;
}
template <>
inline Variant::Type GetVariantType<Vector2i>()
{
    return Variant::kTypeVector2i;
}
template <>
inline Variant::Type GetVariantType<Vector3i>()
{
    return Variant::kTypeVector3i;
}
template <>
inline Variant::Type GetVariantType<Vector4i>()
{
    return Variant::kTypeVector4i;
}
template <>
inline Variant::Type GetVariantType<Matrix2>()
{
    return Variant::kTypeMatrix2f;
}
template <>
inline Variant::Type GetVariantType<Matrix3>()
{
    return Variant::kTypeMatrix3f;
}
template <>
inline Variant::Type GetVariantType<Matrix4>()
{
    return Variant::kTypeMatrix4f;
}
template <>
inline Variant::Type GetVariantType<Matrix2i>()
{
    return Variant::kTypeMatrix2i;
}
template <>
inline Variant::Type GetVariantType<Matrix3i>()
{
    return Variant::kTypeMatrix3i;
}
template <>
inline Variant::Type GetVariantType<Matrix4i>()
{
    return Variant::kTypeMatrix4i;
}
template <>
inline Variant::Type GetVariantType<SharedPtr<RefCounted>>()
{
    return Variant::kTypePtr;
}
template <>
inline Variant::Type GetVariantType<void*>()
{
    return Variant::kTypeRawPtr;
}
template <>
inline Variant::Type GetVariantType<Variant::Vector>()
{
...
template <>
inline Variant::Type GetVariantType<Variant::Map>()
{
